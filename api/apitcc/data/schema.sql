...
DROP TABLE IF EXISTS consumido CASCADE;
...
ALTER TABLE consumido ADD CONSTRAINT pk_livro PRIMARY KEY (id);
ALTER TABLE consumido ADD CONSTRAINT uk_livro UNIQUE (titulo);
ALTER TABLE consumido ADD CONSTRAINT fk_livro_usuario FOREIGN KEY (usuario_id) REFERENCES usuario;
